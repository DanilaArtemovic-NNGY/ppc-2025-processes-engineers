...
class ZorinDBellmanFordPerfTests
    : public ppc::util::BaseRunPerfTests<InTypeWrapper, OutType> {
 protected:
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InTypeWrapper,
                                ZorinDBellmanFordMPI,
                                ZorinDBellmanFordSEQ>(
...
const auto kPerfTestName =
    ZorinDBellmanFordPerfTests::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(RunModeTests,
                         ZorinDBellmanFordPerfTests,
                         kGtestValues,
                         kPerfTestName);
